    ...
    <div className="App">
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/feed" element={<Feed setLoginModal={setLoginModal} userPic={userPic}  setImgs={setImgs} imgs={imgs} init={init} setInit={setInit} logged={userState.logged} username={userState.username}/>}/>
